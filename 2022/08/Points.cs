...
namespace aoc
{
    ...
    public interface IPointish
    {
        ...
        IEnumerable<IPointish> GetSimpleNeighbours();
    }
    ...
    public record Point2 : IPointish
    {
        ...
        public IEnumerable<IPointish> GetSimpleNeighbours()
        {
    ...
    public record Point3 : IPointish
    {
        ...
        IEnumerable<IPointish> IPointish.GetSimpleNeighbours()
        {
            var vector = new Vector3(this.X, this.Y, this.Z);
            return vector.GetSimpleNeighbours().Select(v => (Point3)v);
        }

        public static implicit operator Point3(Point2 p) => new Point3(p.X, p.Y, 0);
        public static implicit operator Point3(Vector3 v) => new Point3((int)v.X, (int)v.Y, (int)v.Z);
        public static implicit operator Vector3(Point3 p) => new Vector3(p.X, p.Y, p.Z);
    }
    ...
    public static class Point2Extensions
    {
        ...
        public static IEnumerable<Point2> GetSimpleNeighbours(this Point2 p)
        {
            yield return p.Up();
            yield return p.Left();
            yield return p.Right();
    ...
    public static class PointExtensions
    {
        ...
        public static IEnumerable<Point> GetSimpleNeighbours(this Point p)
        {
            yield return p.Up();
            yield return p.Left();
            yield return p.Right();
    ...
    public static class VectorExtensions
    {
        ...
        public static IEnumerable<Vector3> GetSimpleNeighbours(this Vector3 p)
        {
            yield return p.Up();
            yield return p.Left();
            yield return p.Right();
    ...
    public static class WalkExtensions{
        public static IEnumerable<(Point2 p, Direction d)> SelectAllDirections(this Point2 point){
            yield return (point, Direction.LEFT);
            yield return (point, Direction.RIGHT);
            yield return (point, Direction.UP);
            yield return (point, Direction.DOWN);
        }
        
        public static IEnumerable<(IHasPosition<Point2> pointish, Direction direction)> SelectAllDirections(this IHasPosition<Point2> pointish){
            yield return (pointish, Direction.LEFT);
            yield return (pointish, Direction.RIGHT);
            yield return (pointish, Direction.UP);
            yield return (pointish, Direction.DOWN);
        }

        public static IEnumerable<Point2> Walk(this Point2 point, Direction d){
            var p = point;
            while(true){
                p = p.Move(d);
                yield return p;
