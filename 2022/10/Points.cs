...
namespace aoc
{
    ...
    public static class Points {
        public static IEnumerable<Point2> GenerateGrid(int maxX, int maxY){
            return Enumerable.Range(0, maxY)
                .SelectMany(y => Enumerable.Range(0, maxX).Select(x => new Point2(x,y)));
        }
    }
}